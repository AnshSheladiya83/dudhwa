import React from 'react';
    ...
    const CustomButton = ({ bgColor, textColor, icon, title, onClick }) => {
        ...
        return (
            <button 
                className={`h-[47px] md:mt-0 mt-2 flex center-both px-2 font-urbanist text-base font-semibold rounded-[10px] bg-primary hover:bg-[#0078C6] text-white  center-v  border border-[#1C1C1C] border-opacity-10 `}
