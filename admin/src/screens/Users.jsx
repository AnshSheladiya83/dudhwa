...
const Users = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen sm:w-screen md:w-auto bg-contentBg">
     <div className="flex md:flex-row flex-col mt-6 ml-6 md:gap-[22px] gap-[15px] items-center justify-between">
  ...
  <div>
    <CustomButton
      ...
      onClick={() => navigate("/create-user")} // navigate to create user screen
    />
  </div>
</div>
